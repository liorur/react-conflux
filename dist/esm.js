import React, { useReducer, useMemo, useLayoutEffect, createContext, useContext } from 'react';
...
function () {
  ...
  _createClass(Store, [{
    ...
    value: function initialSetState(data) {
      this.initialState = _objectSpread({}, this.initialState, {}, data);
    }
  }, {
    key: "setState",
...
var StoreProvider = function StoreProvider(_ref) {
  ...
  var _useReducer = useReducer(store.reducer, store.initialState),
...
var StoresProvider = function StoresProvider(_ref) {
  ...
  Object.keys(userStores).forEach(function (storeName) {
    ...
    wrappedChildren = React.createElement(StoreProvider, {
      store: store,
      context: Context
    }, wrappedChildren);
  });
...
export { Store, StoresProvider, useStore };
